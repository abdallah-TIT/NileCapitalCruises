...
namespace NileCapitalCruises.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240115091354_initDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.BrandType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BrandTypeNameSys")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
                    ...
                    b.ToTable("tbl_Master_Brands_Types");
                });

            modelBuilder.Entity("NileCapitalCruises.Core.Models.BrandTypeContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BrandTypeName")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
                    ...
                    b.HasIndex(new[] { "OriginalTableId" }, "IX_tbl_Master_Brands_Types_Contents_BrandTypeId");

                    b.HasIndex(new[] { "LanguageId" }, "IX_tbl_Master_Brands_Types_Contents_LanguageId");

                    b.ToTable("tbl_Master_Brands_Types_Contents");
                });
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.CruiseFacility", b =>
                {
                    ...
                    b.ToTable("tbl_Master_Cruises_Facilties");
                });
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.DiningType", b =>
                {
                    ...
                    b.ToTable("tbl_CruiseBooking_Dinings_Types");
                });
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.FacilityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FacilityTypeNameSys")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
                    ...
                    b.ToTable("tbl_CruiseBooking_Facilities_Types");
                });

            modelBuilder.Entity("NileCapitalCruises.Core.Models.FacilityTypeContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "OriginalTableId" }, "IX_tbl_Master_Facilities_Types_Contents_FacilityTypeId");

                    b.HasIndex(new[] { "LanguageId" }, "IX_tbl_Master_Facilities_Types_Contents_LanguageId");

                    b.ToTable("tbl_Master_Facilities_Types_Contents");
                });
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.Brand", b =>
                {
                    b.HasOne("NileCapitalCruises.Core.Models.BrandType", "BrandType")
                        .WithMany()
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.CompanyUserCruise", b =>
                {
                    b.HasOne("NileCapitalCruises.Core.ApiModels.CompanyUser", "CompanyUser")
                        .WithMany("UserCruises")
                        .HasForeignKey("CompanyUserId");

                    b.HasOne("NileCapitalCruises.Core.Models.Cruise", "Cruise")
                        .WithMany("CompanyEmployeeCruises")
                        .HasForeignKey("CruiseId");
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.Facility", b =>
                {
                    b.HasOne("NileCapitalCruises.Core.Models.FacilityType", "FacilityType")
                        .WithMany("Facilities")
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.Brand", b =>
                {
                    b.Navigation("BrandsContents");
                });

            modelBuilder.Entity("NileCapitalCruises.Core.Models.BrandType", b =>
                {
                    b.Navigation("BrandTypeContents");
                });
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.Cruise", b =>
                {
                    ...
                    b.Navigation("CompanyEmployeeCruises");
            ...
            modelBuilder.Entity("NileCapitalCruises.Core.Models.FacilityType", b =>
                {
                    ...
                    b.Navigation("FacilityTypeContents");
                });
